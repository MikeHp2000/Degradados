...
class TableViewController: UIViewController,UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    var filteredShapes = [Shape]()
        ...
        func initList()
        {
            ...
            Lugar(Salon: "AS 101", Unidad: "A", Uname: "Component 1", Iname: "inte")
            Lugar(Salon: "AS 102", Unidad: "A", Uname: "Component 1", Iname: "neko")
            Lugar(Salon: "AS 103", Unidad: "A", Uname: "Component 1", Iname: "neko")
            Lugar(Salon: "AS 104", Unidad: "A", Uname: "Component 1", Iname: "neko")
            Lugar(Salon: "AS 105", Unidad: "A", Uname: "Component 1", Iname: "neko")
            Lugar(Salon: "AS 106", Unidad: "A", Uname: "Component 1", Iname: "neko")
        ...
        func initSearchController() {
            ...
            searchController.searchBar.scopeButtonTitles = ["All","AS","Lab"]
